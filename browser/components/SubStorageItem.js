...
const SubStorageItem = ({
  ...
  return (
    <button
      styleName={isParentActive || isActive ? 'subFolderList-item--active' : 'subFolderList-item'}
...
export default CSSModules(SubStorageItem, styles)
